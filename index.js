...
function play(x) {
  ...
  if (count % 2 != 0) {
    document.getElementById(x).style.backgroundImage =
      "url(https://toppng.com/uploads/preview/wrong-cross-symbol-11562969015bvubqupjq3.png)";
    ...
    document.getElementById(x).style.backgroundImage =
      "url(https://www.transparentpng.com/thumb/red-circle/empty-middle-thick-red-circle-transparent-background-64GGHf.png)";
